            ...
            <div class="row clearfix">
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="header">
                            <h2>Outword Register</h2>
                        </div>
                        <div class="body">
                        	
                        	<form action="/SMGMT/OutwordRegister" id="form_validation" method="Post">	                           
								<div class="row clearfix">									 						
									<div class="col-md-6">
										<div class="form-group form-float">
											<div class="form-line">
												...
												<label class="form-label">Outword No</label>
											</div>
										</div>
									</div>	
									<div class="col-md-6">
									...
									<div class="col-md-6">
										<div class="form-group form-float">
											<select class="form-control show-tick" name="sectionList" multiple="multiple" title="Receiver Name" data-live-search="true">
									          <option ></option>   
								  			 </select>
